...
contract MDaiDelegate is MErc20Delegate {
    ...
    function _becomeImplementation(bytes memory data) public {
        require(msg.sender == momaMaster.admin(), "only the admin may initialize the implementation");
    ...
    function _resignImplementation() public {
        require(msg.sender == momaMaster.admin(), "only the admin may abandon the implementation");
